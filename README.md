...
|Video Game Wishlist | Wrote SQL queries to form a database of my own personal video game collection. Mostly for fun, with some actual practicality for personal organization and practice with SQL. | creating & editing tables, data filtering, aggregate functions |
