...
|[Video Game Wishlist](https://github.com/mwdemos/Data-Analysis-Portfolio/blob/main/Video%20Game%20Wishlist) | Wrote SQL queries to start a database of my own personal video game collection. Mostly for fun, with some organizational practicality and practice with SQL. | creating & editing tables, data filtering, aggregate functions |
