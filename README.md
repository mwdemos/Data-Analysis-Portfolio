...
| R Statistics Projects | Some samples of my work with R from undergraduate statistics coursework. Rstudio, Minitab, Excel. | statistical and graphical functions in R, statistical analysis, data visualization, regression models |
